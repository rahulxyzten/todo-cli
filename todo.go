...
func (todos *Todos) print() {
	...
	tb.SetHeaders("#", "Title", "Completed", "Created At", "Completed At")
	tb.SetAlignment(table.AlignCenter, table.AlignLeft, table.AlignCenter, table.AlignCenter, table.AlignCenter)
	tb.SetHeaderStyle(table.StyleBold)
	tb.SetLineStyle(table.StyleBlue)
